...
├── fill_rc13_bundle.py      # Preenchimento do bundle RC v13 (Fases 7-8)
...
Executa o protocolo RC_v13_CANON completo (Fases 1-6):
...
- Para criar RCs futuros, duplicar `run_rc13.py` / `fill_rc13_bundle.py` e adaptar
