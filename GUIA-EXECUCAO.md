...
**Último RC**: RC_v13_CANON — 963 testes, 95.04% coverage, 3/3 gates PASS.
...
FASE 5: Tests + Coverage    → pytest (963 tests), coverage >= 95%
...
- `RC_TEMPLATE_DESIGN-rc13.md` — estrutura canônica do bundle (v2.0)
- `RC_EXECUTION_PROMPT-rc13.md` — prompt de execução para agente AI (v2.0)
...
```
tests/1-uc-ontology/        <- 963 testes (UC-101 a UC-108)
