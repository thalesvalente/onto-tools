...
**Arquivo:** `audit-log-session-20260310-155225.json`
## 📊 Sumário Executivo
- **Operação:** Carregamento de Ontologia- **Arquivo:** `energy-domain-ontology.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-03-10T15:52:25.922134
...
- **Data/Hora:** 2026-03-10T15:53:24.355590
...
- **`PartNumber`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'peça'→'Peça', 'acessório'→'Acessório'
- **`UpperItubeDiameter`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] acrônimos: TUBE; [pt-br] Title Case: 'superior'→'Superior'
- **`StrIntOnNoTensMaxPressValRefMult`**
...
- **`ChemicalInjectionUnit`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'injection'→'Injection', 'unit'→'Unit'; [pt-br] Title Case: 'injeção'→'Injeção', 'químicos'→'Químicos'
- **`StrIntOnNoTensNomPressValRefMult`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'With'→'with'
- **`TubingHanger`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'hanger'→'Hanger'; [pt-br] Title Case: 'coluna'→'Coluna'
- **`MinimumThermalExchangeCoefficient`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: '(TEC)'→'(tec)'; [pt-br] Title Case: '(TEC)'→'(tec)'
- **`StressAtDesignPressure`**
...
- **`ROVTool`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'tool'→'Tool'
- **`GrvCntrPntDstnceFrmTermFlange`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'From'→'from'
- **`RunOfRiver`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Run-of-River'→'Run-Of-River'; [pt-br] Title Case: 'd’Água'→'D’água'
- **`CriticalCurvatureOfSlipping`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Of'→'of'; [pt-br] Title Case: 'crítica'→'Crítica', 'escorregamento'→'Escorregamento'
- **`FSHRLowerAssembly`**
...
- **`StructureCode`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'estrutura'→'Estrutura'
- **`HasModaSensor`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'MODA'→'Moda'
- **`TestEquipment`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'equipment'→'Equipment'; [pt-br] Title Case: 'teste'→'Teste'

- **Operação:** Geração de Arquivo de Revisão- **Arquivo Gerado:** `test-norm-autofix-disabled.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-03-10T15:53:58.777335

---
*Relatório gerado automaticamente em 2026-03-10 15:53:58*
