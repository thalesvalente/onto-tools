...
**Arquivo:** `audit-log-session-20260310-160056.json`
## 📊 Sumário Executivo
- **Operação:** Carregamento de Ontologia- **Arquivo:** `energy-domain-ontology.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-03-10T16:00:56.825315
...
- **Data/Hora:** 2026-03-10T16:01:02.255276
...
- **`TypeLevelAttribute`**
  - Problema: Classe 'TypeLevelAttribute' não possui dcterms:identifier
  - Correção: `TypeLevelAttribute`
- **`Table`**
  - Problema: Classe 'Table' não possui dcterms:identifier
  - Correção: `Table`
- **`RotatingEquipmentEngineering`**
  - Problema: Classe 'RotatingEquipmentEngineering' não possui dcterms:identifier
  - Correção: `RotatingEquipmentEngineering`
...
- **`MultiValue`**
  - Problema: Classe 'MultiValue' não possui dcterms:identifier
  - Correção: `MultiValue`
- **`DomainAttribute`**
  - Problema: Classe 'DomainAttribute' não possui dcterms:identifier
  - Correção: `DomainAttribute`
- **`Version`**
  - Problema: Classe 'Version' não possui dcterms:identifier
  - Correção: `Version`
...
- **`InstanceLevelAttribute`**
  - Problema: Classe 'InstanceLevelAttribute' não possui dcterms:identifier
  - Correção: `InstanceLevelAttribute`
- **`Status`**
  - Problema: Classe 'Status' não possui dcterms:identifier
  - Correção: `Status`
- **`Decommissioning`**
  - Problema: Classe 'Decommissioning' não possui dcterms:identifier
  - Correção: `Decommissioning`
- **`Hydropower`**
  - Problema: Classe 'Hydropower' não possui dcterms:identifier
  - Correção: `Hydropower`
- **`OilAndGas`**
...
- **`LayingMinimumRadiusCurveAttribute`**
  - Problema: Classe 'LayingMinimumRadiusCurveAttribute' não possui dcterms:identifier
  - Correção: `LayingMinimumRadiusCurveAttribute`
- **`ElectricalEngineering`**
  - Problema: Classe 'ElectricalEngineering' não possui dcterms:identifier
  - Correção: `ElectricalEngineering`
...
- **`HasThermalInsulation`**
  - Problema: DomainAttribute 'HasThermalInsulation' não possui skos:definition em inglês (@en)
- **`MaxDesignAbsIntPresTableColumn`**
...
- **`HydrostaticPressureTestsAttribute`**
  - Problema: DomainAttribute 'HydrostaticPressureTestsAttribute' não possui skos:definition em português (@pt-br)
- **`WorkingLoadLimit`**
  - Problema: DomainAttribute 'WorkingLoadLimit' não possui skos:definition em português (@pt-br)
- **`DiffusionTableDiffusionCoefficient`**
  - Problema: DomainAttribute 'DiffusionTableDiffusionCoefficient' não possui skos:definition em português (@pt-br)
- **`UltTensStrAlongFibers`**
  - Problema: DomainAttribute 'UltTensStrAlongFibers' não possui skos:definition em português (@pt-br)
- **`IntermediateValuesStrategy`**
  - Problema: DomainAttribute 'IntermediateValuesStrategy' não possui skos:definition em português (@pt-br)
...
- **`DrawingDimensionsTableDimensionName`**
  - Problema: DomainAttribute 'DrawingDimensionsTableDimensionName' não possui skos:definition em português (@pt-br)
- **`GalvanicMaterial`**
  - Problema: DomainAttribute 'GalvanicMaterial' não possui skos:definition em português (@pt-br)
- **`StrandsTableAttribute`**
  - Problema: DomainAttribute 'StrandsTableAttribute' não possui skos:definition em português (@pt-br)
- **`RuptDefAlongFibers`**
  - Problema: DomainAttribute 'RuptDefAlongFibers' não possui skos:definition em português (@pt-br)
- **`ManufacturingDate`**
  - Problema: DomainAttribute 'ManufacturingDate' não possui skos:definition em português (@pt-br)
- **`StrandsTableColumn`**
  - Problema: DomainAttribute 'StrandsTableColumn' não possui skos:definition em português (@pt-br)
- **`AnodeCollarsAxialSpacing`**
  - Problema: DomainAttribute 'AnodeCollarsAxialSpacing' não possui skos:definition em português (@pt-br)
- **`MetallicLayerPitch`**
  - Problema: DomainAttribute 'MetallicLayerPitch' não possui skos:definition em português (@pt-br)
- **`MaximumTemperature`**
  - Problema: DomainAttribute 'MaximumTemperature' não possui skos:definition em português (@pt-br)
- **`LayerWatertight`**
  - Problema: DomainAttribute 'LayerWatertight' não possui skos:definition em português (@pt-br)
- **`FlangeType`**
  - Problema: DomainAttribute 'FlangeType' não possui skos:definition em português (@pt-br)
...
- **`StrandsTableAttribute`**
  - Problema: DomainAttribute 'StrandsTableAttribute' não possui propriedade obrigatória: edo:hasLifecycleCreationPhase
- **`StrandsTableAttribute`**
  - Problema: DomainAttribute 'StrandsTableAttribute' não possui propriedade obrigatória: edo:hasTypedValue
- **`StrandsTableAttribute`**
  - Problema: DomainAttribute 'StrandsTableAttribute' não possui propriedade obrigatória: edo:hasValueCardinality
- **`StrandsTableColumn`**
...
- **`LayingMinimumRadiusCurveAttribute`**
  - Problema: DomainAttribute 'LayingMinimumRadiusCurveAttribute' não possui propriedade obrigatória: edo:hasAttributeScope
...
- **`DiffusionTableDiffusionCoefficient`**
  - Problema: skos:prefLabel 'Coeficiente de difusão'@pt-br não corresponde ao padrão esperado. Causa: palavra 'difusão' deve começar com maiúscula (não é stopword)
- **`UltTensStrAlongFibers`**
  - Problema: skos:prefLabel 'Tensão máxima de tração longitudinalmente às fibras'@pt-br não corresponde ao padrão esperado. Causa: palavra 'máxima' deve começar com maiúscula (não é stopword)
- **`BlockValve`**
...
- **`UmbilicalComponent`**
  - Problema: skos:prefLabel 'Componente de umbilical'@pt-br não corresponde ao padrão esperado. Causa: palavra 'umbilical' deve começar com maiúscula (não é stopword)
- **`UmbilicalComponent`**
  - Problema: skos:prefLabel 'Umbilical component'@en não corresponde ao padrão esperado. Causa: palavra 'component' deve começar com maiúscula (não é stopword)
- **`ClampInternalDiameter`**
  - Problema: skos:prefLabel 'Diâmetro interno do clamp'@pt-br não corresponde ao padrão esperado. Causa: palavra 'interno' deve começar com maiúscula (não é stopword)
- **`DrawingDimensionsTableDimensionName`**
  - Problema: skos:prefLabel 'Nome da dimensão'@pt-br não corresponde ao padrão esperado. Causa: palavra 'dimensão' deve começar com maiúscula (não é stopword)
- **`RigidJumper`**
...
- **`RuptDefAlongFibers`**
  - Problema: skos:prefLabel 'Deformação de Ruptura longitudinalmente às fibras'@pt-br não corresponde ao padrão esperado. Causa: palavra 'longitudinalmente' deve começar com maiúscula (não é stopword)
- **`DeploymentAccessory`**
  - Problema: skos:prefLabel 'Acessório de lançamento'@pt-br não corresponde ao padrão esperado. Causa: palavra 'lançamento' deve começar com maiúscula (não é stopword)
- **`DeploymentAccessory`**
  - Problema: skos:prefLabel 'Deployment accessory'@en não corresponde ao padrão esperado. Causa: palavra 'accessory' deve começar com maiúscula (não é stopword)
- **`StaticUmbilicalSpan`**
...
- **`RoboticActuator`**
  - Problema: skos:prefLabel 'Robotic actuator'@en não corresponde ao padrão esperado. Causa: palavra 'actuator' deve começar com maiúscula (não é stopword)

### 📏 Regra: **`PREFLABEL_NEEDS_CORRECTION`** (206 ocorrências)
*Mostrando 20 de 206 exemplos*
- **`ThreadsPerInch`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Per'→'per'
- **`ClampInternalDiameter`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'interno'→'Interno', 'clamp'→'Clamp'
- **`TPT`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'temperature'→'Temperature', 'sensor'→'Sensor'; [pt-br] Title Case: 'pressão'→'Pressão', 'temperatura'→'Temperatura'
- **`FSHRUpperAssembly`**
...
- **`PressureSensor`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'sensor'→'Sensor'; [pt-br] Title Case: 'pressão'→'Pressão'
- **`HydraulicJumper`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'jumper'→'Jumper'; [pt-br] Title Case: 'hidráulico'→'Hidráulico'
- **`ElectricalJumper`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'jumper'→'Jumper'; [pt-br] Title Case: 'elétrico'→'Elétrico'
- **`InternalVolume`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'interno'→'Interno'
- **`HubProtectionCap`**
...
- **`SpliceBox`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'box'→'Box'; [pt-br] Title Case: 'emenda'→'Emenda'
- **`TieIn`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Tie-in'→'Tie-In'; [pt-br] Title Case: 'Tie-in'→'Tie-In'
- **`PressureEquipment`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Pressure-containing'→'Pressure-Containing', 'equipment'→'Equipment'; [pt-br] Title Case: 'contenção'→'Contenção', 'pressão'→'Pressão'
- **`FlowlineSpan`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'span'→'Span'; [pt-br] Title Case: 'flowline'→'Flowline'
- **`SolubilityCurveAttribute`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: '(Specific'→'(specific'; [pt-br] Title Case: '(Específica'→'(específica'
- **`OuterDiameter`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'externo'→'Externo'

- **Operação:** Geração de Arquivo de Revisão- **Arquivo Gerado:** `test-norm-autofix-enabled-canon.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-03-10T16:01:30.097644

---
*Relatório gerado automaticamente em 2026-03-10 16:01:30*
