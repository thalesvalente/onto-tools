...
**Arquivo:** `audit-log-session-20260308-232450.json`
## 📊 Sumário Executivo
- **Operação:** Carregamento de Ontologia- **Arquivo:** `energy-domain-ontology.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-03-08T23:24:50.326923
...
- **Data/Hora:** 2026-03-08T23:24:50.884096
...
- **`SolubilityTableColumn`**
  - Problema: Classe 'SolubilityTableColumn' não possui dcterms:identifier
  - Correção: `SolubilityTableColumn`
- **`EModVsTempCurveAttribute`**
  - Problema: Classe 'EModVsTempCurveAttribute' não possui dcterms:identifier
...
- **`Port`**
  - Problema: Classe 'Port' não possui dcterms:identifier
  - Correção: `Port`
- **`Nuclear`**
  - Problema: Classe 'Nuclear' não possui dcterms:identifier
  - Correção: `Nuclear`
- **`Installation`**
  - Problema: Classe 'Installation' não possui dcterms:identifier
  - Correção: `Installation`
- **`SubseaRigidPipeSpec`**
...
- **`TechnicalDiscipline`**
  - Problema: Classe 'TechnicalDiscipline' não possui dcterms:identifier
  - Correção: `TechnicalDiscipline`
- **`OilAndGas`**
  - Problema: Classe 'OilAndGas' não possui dcterms:identifier
  - Correção: `OilAndGas`
...
- **`HydrogenEnergy`**
  - Problema: Classe 'HydrogenEnergy' não possui dcterms:identifier
  - Correção: `HydrogenEnergy`
- **`LifecyclePhase`**
  - Problema: Classe 'LifecyclePhase' não possui dcterms:identifier
  - Correção: `LifecyclePhase`
- **`ReferenceDocument`**
...
- **`ToBeDeprecated`**
  - Problema: Classe 'ToBeDeprecated' não possui dcterms:identifier
  - Correção: `ToBeDeprecated`
...
- **`InternalIncidentalPressureCurveAttribute`**
  - Problema: DomainAttribute 'InternalIncidentalPressureCurveAttribute' não possui skos:definition em português (@pt-br)
- **`LubricantFrictionFactor`**
  - Problema: DomainAttribute 'LubricantFrictionFactor' não possui skos:definition em português (@pt-br)
- **`DiffusionTableTemperature`**
  - Problema: DomainAttribute 'DiffusionTableTemperature' não possui skos:definition em português (@pt-br)
- **`SolubilityTableColumn`**
  - Problema: DomainAttribute 'SolubilityTableColumn' não possui skos:definition em português (@pt-br)
- **`HasN2InjectionPort`**
  - Problema: DomainAttribute 'HasN2InjectionPort' não possui skos:definition em português (@pt-br)
- **`EModVsTempCurveAttribute`**
  - Problema: DomainAttribute 'EModVsTempCurveAttribute' não possui skos:definition em português (@pt-br)
- **`FrictionCoefficientTighteningTableTighteningPerTrack`**
  - Problema: DomainAttribute 'FrictionCoefficientTighteningTableTighteningPerTrack' não possui skos:definition em português (@pt-br)
- **`SafeWorkingLoad`**
  - Problema: DomainAttribute 'SafeWorkingLoad' não possui skos:definition em português (@pt-br)
- **`SpoolingTension`**
...
- **`MaximumAllowableTensionTableMaximumAllowableTensile`**
  - Problema: DomainAttribute 'MaximumAllowableTensionTableMaximumAllowableTensile' não possui skos:definition em português (@pt-br)
- **`ThreadStandard`**
...
- **`TensionerPadsOpeningAngle`**
  - Problema: DomainAttribute 'TensionerPadsOpeningAngle' não possui skos:definition em português (@pt-br)
- **`EarlyLeakNomPressTableTensLimitValRef`**
  - Problema: DomainAttribute 'EarlyLeakNomPressTableTensLimitValRef' não possui skos:definition em português (@pt-br)
- **`PlannedStartTimestamp`**
  - Problema: DomainAttribute 'PlannedStartTimestamp' não possui skos:definition em português (@pt-br)
...
- **`InternalIncidentalPressureCurveAttribute`**
  - Problema: DomainAttribute 'InternalIncidentalPressureCurveAttribute' não possui propriedade obrigatória: edo:hasTypedValue
- **`InternalIncidentalPressureCurveAttribute`**
  - Problema: DomainAttribute 'InternalIncidentalPressureCurveAttribute' não possui propriedade obrigatória: edo:hasValueCardinality
- **`SolubilityTableColumn`**
  - Problema: DomainAttribute 'SolubilityTableColumn' não possui propriedade obrigatória: edo:hasAttributeScope
- **`SolubilityTableColumn`**
  - Problema: DomainAttribute 'SolubilityTableColumn' não possui propriedade obrigatória: edo:hasLifecycleCreationPhase
- **`SolubilityTableColumn`**
  - Problema: DomainAttribute 'SolubilityTableColumn' não possui propriedade obrigatória: edo:hasTypedValue
- **`SolubilityTableColumn`**
  - Problema: DomainAttribute 'SolubilityTableColumn' não possui propriedade obrigatória: edo:hasValueCardinality
- **`EModVsTempCurveAttribute`**
...
- **`DimensionsTableColumn`**
  - Problema: DomainAttribute 'DimensionsTableColumn' não possui propriedade obrigatória: edo:hasAttributeScope
- **`DimensionsTableColumn`**
  - Problema: DomainAttribute 'DimensionsTableColumn' não possui propriedade obrigatória: edo:hasLifecycleCreationPhase
- **`DimensionsTableColumn`**
  - Problema: DomainAttribute 'DimensionsTableColumn' não possui propriedade obrigatória: edo:hasTypedValue
- **`DimensionsTableColumn`**
  - Problema: DomainAttribute 'DimensionsTableColumn' não possui propriedade obrigatória: edo:hasValueCardinality
- **`InternalIncidentalPressureTableColumn`**
...
- **`NumberOfChokeValves`**
  - Problema: skos:prefLabel 'Número de válvulas de estrangulamento'@pt-br não corresponde ao padrão esperado. Causa: palavra 'válvulas' deve começar com maiúscula (não é stopword)
- **`LubricantFrictionFactor`**
  - Problema: skos:prefLabel 'Fator de atrito do lubrificante'@pt-br não corresponde ao padrão esperado. Causa: palavra 'atrito' deve começar com maiúscula (não é stopword)
- **`StaticUmbilicalSpan`**
...
- **`ElectronicDevice`**
  - Problema: skos:prefLabel 'Dispositivo eletrônico'@pt-br não corresponde ao padrão esperado. Causa: palavra 'eletrônico' deve começar com maiúscula (não é stopword)
- **`ElectronicDevice`**
  - Problema: skos:prefLabel 'Electronic device'@en não corresponde ao padrão esperado. Causa: palavra 'device' deve começar com maiúscula (não é stopword)
- **`FiberRopeSegment`**
  - Problema: skos:prefLabel 'Fiber rope segment'@en não corresponde ao padrão esperado. Causa: palavra 'rope' deve começar com maiúscula (não é stopword)
- **`FiberRopeSegment`**
  - Problema: skos:prefLabel 'Tramo de cabo de fibra'@pt-br não corresponde ao padrão esperado. Causa: palavra 'cabo' deve começar com maiúscula (não é stopword)
- **`TubingHanger`**
  - Problema: skos:prefLabel 'Suspensor de coluna'@pt-br não corresponde ao padrão esperado. Causa: palavra 'coluna' deve começar com maiúscula (não é stopword)
- **`TubingHanger`**
  - Problema: skos:prefLabel 'Tubing hanger'@en não corresponde ao padrão esperado. Causa: palavra 'hanger' deve começar com maiúscula (não é stopword)
- **`HydraulicPowerUnit`**
  - Problema: skos:prefLabel 'Unidade de potência hidráulica'@pt-br não corresponde ao padrão esperado. Causa: palavra 'potência' deve começar com maiúscula (não é stopword)
- **`HydraulicPowerUnit`**
  - Problema: skos:prefLabel 'Hydraulic power unit'@en não corresponde ao padrão esperado. Causa: palavra 'power' deve começar com maiúscula (não é stopword)
- **`FrictionCoefficientTighteningTableTighteningPerTrack`**
  - Problema: skos:prefLabel 'Aperto por lagarta'@pt-br não corresponde ao padrão esperado. Causa: palavra 'lagarta' deve começar com maiúscula (não é stopword)
- **`RotatingMachine`**
  - Problema: skos:prefLabel 'Rotating machine'@en não corresponde ao padrão esperado. Causa: palavra 'machine' deve começar com maiúscula (não é stopword)
- **`RotatingMachine`**
  - Problema: skos:prefLabel 'Máquina rotativa'@pt-br não corresponde ao padrão esperado. Causa: palavra 'rotativa' deve começar com maiúscula (não é stopword)
- **`HubProtectionCap`**
  - Problema: skos:prefLabel 'Hub protection cap'@en não corresponde ao padrão esperado. Causa: palavra 'protection' deve começar com maiúscula (não é stopword)
- **`HubProtectionCap`**
  - Problema: skos:prefLabel 'Capa de proteção de hub'@pt-br não corresponde ao padrão esperado. Causa: palavra 'proteção' deve começar com maiúscula (não é stopword)
- **`LPHousing`**
  - Problema: skos:prefLabel 'Alojador de baixa pressão'@pt-br não corresponde ao padrão esperado. Causa: palavra 'baixa' deve começar com maiúscula (não é stopword)
- **`LPHousing`**
  - Problema: skos:prefLabel 'Low-pressure housing'@en não corresponde ao padrão esperado. Causa: palavra 'pressure' em 'Low-pressure' deve começar com maiúscula
- **`RoboticActuator`**
  - Problema: skos:prefLabel 'Atuador robótico'@pt-br não corresponde ao padrão esperado. Causa: palavra 'robótico' deve começar com maiúscula (não é stopword)
...
- **Operação:** Geração de Arquivo de Revisão- **Arquivo Gerado:** `canonical_output_run4.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-03-08T23:24:51.178258

---
*Relatório gerado automaticamente em 2026-03-08 23:24:51*
