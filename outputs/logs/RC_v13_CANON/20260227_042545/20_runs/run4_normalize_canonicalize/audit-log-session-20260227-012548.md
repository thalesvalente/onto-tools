...
**Arquivo:** `audit-log-session-20260227-012548.json`
## 📊 Sumário Executivo
- **Operação:** Carregamento de Ontologia- **Arquivo:** `energy-domain-ontology.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-02-27T01:25:48.605633
...
- **Data/Hora:** 2026-02-27T01:25:49.190040
...
- **`OpticalFiberCable`** — `MULTIPLE_PREFLABEL_SAME_LANG`
  - Classe tem 2 skos:prefLabel para idioma 'pt-br': ['Cabo de fibra ótica', 'Cabo de Fibra Óptica']
...
- **`UmbilicalComponent`** — `MULTIPLE_PREFLABEL_SAME_LANG`
  ...
  - Classe tem 2 skos:prefLabel para idioma 'pt-br': ['Componente de umbilical', 'Componente Umbilical']
...
- **`ProcessPipingEngineering`**
  - Problema: Classe 'ProcessPipingEngineering' não possui dcterms:identifier
  - Correção: `ProcessPipingEngineering`
- **`ConsumableElement`**
  - Problema: Classe 'ConsumableElement' não possui dcterms:identifier
  - Correção: `ConsumableElement`
- **`StaticEquipmentEngineering`**
  - Problema: Classe 'StaticEquipmentEngineering' não possui dcterms:identifier
  - Correção: `StaticEquipmentEngineering`
- **`ConceptualDesign`**
  - Problema: Classe 'ConceptualDesign' não possui dcterms:identifier
  - Correção: `ConceptualDesign`
- **`Procurement`**
  - Problema: Classe 'Procurement' não possui dcterms:identifier
  - Correção: `Procurement`
- **`DeclaredValue`**
...
- **`CrushingMaximumAllowableTensionTableColumn`**
  - Problema: Classe 'CrushingMaximumAllowableTensionTableColumn' não possui dcterms:identifier
...
- **`RingGasketAttribute`**
  - Problema: Classe 'RingGasketAttribute' não possui dcterms:identifier
  - Correção: `RingGasketAttribute`
- **`FabricationComponent`**
  - Problema: Classe 'FabricationComponent' não possui dcterms:identifier
  - Correção: `FabricationComponent`
- **`Geothermal`**
  - Problema: Classe 'Geothermal' não possui dcterms:identifier
  - Correção: `Geothermal`
- **`NuclearFuelCycle`**
  - Problema: Classe 'NuclearFuelCycle' não possui dcterms:identifier
  - Correção: `NuclearFuelCycle`
- **`AttributeClassification`**
  - Problema: Classe 'AttributeClassification' não possui dcterms:identifier
  - Correção: `AttributeClassification`
- **`SubseaEngineering`**
  - Problema: Classe 'SubseaEngineering' não possui dcterms:identifier
  - Correção: `SubseaEngineering`
- **`Nuclear`**
  - Problema: Classe 'Nuclear' não possui dcterms:identifier
  - Correção: `Nuclear`
- **`IfcInstanciableElement`**
  - Problema: Classe 'IfcInstanciableElement' não possui dcterms:identifier
  - Correção: `IfcInstanciableElement`
- **`IntValue`**
  - Problema: Classe 'IntValue' não possui dcterms:identifier
  - Correção: `IntValue`
- **`DecimalValue`**
...
- **`InternalIncidentalPressureTablePressure`**
  - Problema: DomainAttribute 'InternalIncidentalPressureTablePressure' não possui skos:definition em português (@pt-br)
- **`PermeabilityTableTemperature`**
...
- **`MaxDynamicLoad`**
  - Problema: DomainAttribute 'MaxDynamicLoad' não possui skos:definition em português (@pt-br)
- **`EarlyLeakNomPressTableTensLimitValRef`**
  - Problema: DomainAttribute 'EarlyLeakNomPressTableTensLimitValRef' não possui skos:definition em português (@pt-br)
- **`BendingMomentTableCurvature`**
  - Problema: DomainAttribute 'BendingMomentTableCurvature' não possui skos:definition em português (@pt-br)
- **`ProjectCode`**
  - Problema: DomainAttribute 'ProjectCode' não possui skos:definition em português (@pt-br)
- **`MetallicLayerMaterialType`**
  - Problema: DomainAttribute 'MetallicLayerMaterialType' não possui skos:definition em português (@pt-br)
- **`EarlyLeakMaxPressTableTensLimitValRef`**
  - Problema: DomainAttribute 'EarlyLeakMaxPressTableTensLimitValRef' não possui skos:definition em português (@pt-br)
- **`SerialNumber`**
  - Problema: DomainAttribute 'SerialNumber' não possui skos:definition em português (@pt-br)
- **`UltTensStrPerpendFibers`**
  - Problema: DomainAttribute 'UltTensStrPerpendFibers' não possui skos:definition em português (@pt-br)
- **`RingGasketMaterial`**
  - Problema: DomainAttribute 'RingGasketMaterial' não possui skos:definition em português (@pt-br)
- **`MinimumTemperature`**
  - Problema: DomainAttribute 'MinimumTemperature' não possui skos:definition em português (@pt-br)
- **`RingGasketPressureRating`**
  - Problema: DomainAttribute 'RingGasketPressureRating' não possui skos:definition em português (@pt-br)
- **`Mass`**
  - Problema: DomainAttribute 'Mass' não possui skos:definition em português (@pt-br)
- **`ThreadStandard`**
  - Problema: DomainAttribute 'ThreadStandard' não possui skos:definition em português (@pt-br)
- **`CrushingMaximumAllowableTensionTableColumn`**
  - Problema: DomainAttribute 'CrushingMaximumAllowableTensionTableColumn' não possui skos:definition em português (@pt-br)
- **`InsideTemperature`**
  - Problema: DomainAttribute 'InsideTemperature' não possui skos:definition em português (@pt-br)
- **`PullingHeadType`**
  - Problema: DomainAttribute 'PullingHeadType' não possui skos:definition em português (@pt-br)
- **`EmodVsTempTableTemperature`**
  - Problema: DomainAttribute 'EmodVsTempTableTemperature' não possui skos:definition em português (@pt-br)
...
- **`FlangeAttribute`**
  - Problema: DomainAttribute 'FlangeAttribute' não possui skos:prefLabel em português (@pt-br)
- **`HydrostaticPressureTestsAttribute`**
...
- **`CrushingMaximumAllowableTensionTableColumn`**
  - Problema: DomainAttribute 'CrushingMaximumAllowableTensionTableColumn' não possui propriedade obrigatória: edo:hasAttributeScope
- **`CrushingMaximumAllowableTensionTableColumn`**
  - Problema: DomainAttribute 'CrushingMaximumAllowableTensionTableColumn' não possui propriedade obrigatória: edo:hasLifecycleCreationPhase
- **`CrushingMaximumAllowableTensionTableColumn`**
  - Problema: DomainAttribute 'CrushingMaximumAllowableTensionTableColumn' não possui propriedade obrigatória: edo:hasTypedValue
- **`CrushingMaximumAllowableTensionTableColumn`**
  - Problema: DomainAttribute 'CrushingMaximumAllowableTensionTableColumn' não possui propriedade obrigatória: edo:hasValueCardinality
- **`MaterialManufacturerAttribute`**
...
- **`RingGasketAttribute`**
  - Problema: DomainAttribute 'RingGasketAttribute' não possui propriedade obrigatória: edo:hasAttributeScope
- **`RingGasketAttribute`**
  - Problema: DomainAttribute 'RingGasketAttribute' não possui propriedade obrigatória: edo:hasLifecycleCreationPhase
- **`RingGasketAttribute`**
  - Problema: DomainAttribute 'RingGasketAttribute' não possui propriedade obrigatória: edo:hasTypedValue
- **`RingGasketAttribute`**
  - Problema: DomainAttribute 'RingGasketAttribute' não possui propriedade obrigatória: edo:hasValueCardinality
- **`EModVsTempCurveAttribute`**
  - Problema: DomainAttribute 'EModVsTempCurveAttribute' não possui propriedade obrigatória: edo:hasAttributeScope
- **`EModVsTempCurveAttribute`**
  - Problema: DomainAttribute 'EModVsTempCurveAttribute' não possui propriedade obrigatória: edo:hasLifecycleCreationPhase
- **`EModVsTempCurveAttribute`**
  - Problema: DomainAttribute 'EModVsTempCurveAttribute' não possui propriedade obrigatória: edo:hasTypedValue
- **`EModVsTempCurveAttribute`**
  - Problema: DomainAttribute 'EModVsTempCurveAttribute' não possui propriedade obrigatória: edo:hasValueCardinality
- **`BendingStiffnessTableColumn`**
...
- **`OpticalFiberCable`**
  - Problema: Classe tem 2 skos:prefLabel para idioma 'pt-br': ['Cabo de fibra ótica', 'Cabo de Fibra Óptica']
- **`OpticalFiberCable`**
...
- **`UmbilicalComponent`**
  - Problema: Classe tem 2 skos:prefLabel para idioma 'pt-br': ['Componente de umbilical', 'Componente Umbilical']

### 📏 Regra: **`PREFLABEL_FORMAT_INVALID`** (267 ocorrências)
*Mostrando 20 de 267 exemplos*
- **`RunOfRiver`**
  - Problema: skos:prefLabel 'Hidrelétrica a Fio d’Água'@pt-br não corresponde ao padrão esperado. Causa: contém caracteres inválidos: ['’']
- **`RunOfRiver`**
  - Problema: skos:prefLabel 'Hidrelétrica a Fio d’Água'@pt-br não corresponde ao padrão esperado. Causa: palavra 'd’Água' deve começar com maiúscula (não é stopword)
- **`ProjectCode`**
...
- **`HCM`**
  - Problema: skos:prefLabel 'Horizontal connection module'@en não corresponde ao padrão esperado. Causa: palavra 'connection' deve começar com maiúscula (não é stopword)
- **`HCM`**
  - Problema: skos:prefLabel 'Módulo de conexão horizontal'@pt-br não corresponde ao padrão esperado. Causa: palavra 'conexão' deve começar com maiúscula (não é stopword)
- **`UTA`**
  - Problema: skos:prefLabel 'Umbilical termination assembly'@en não corresponde ao padrão esperado. Causa: palavra 'termination' deve começar com maiúscula (não é stopword)
- **`UTA`**
  - Problema: skos:prefLabel 'Conjunto de terminação de umbilical'@pt-br não corresponde ao padrão esperado. Causa: palavra 'terminação' deve começar com maiúscula (não é stopword)
- **`UltTensStrPerpendFibers`**
  - Problema: skos:prefLabel 'Tensão máxima de tração perpendicularmente às fibras'@pt-br não corresponde ao padrão esperado. Causa: palavra 'máxima' deve começar com maiúscula (não é stopword)
- **`LogicCap`**
  - Problema: skos:prefLabel 'Capa lógica'@pt-br não corresponde ao padrão esperado. Causa: palavra 'lógica' deve começar com maiúscula (não é stopword)
- **`LogicCap`**
  - Problema: skos:prefLabel 'Logic cap'@en não corresponde ao padrão esperado. Causa: palavra 'cap' deve começar com maiúscula (não é stopword)
- **`BlockValve`**
...
- **`InlineT`**
  - Problema: skos:prefLabel ''T' em linha'@pt-br não corresponde ao padrão esperado. Causa: formato não corresponde ao padrão Title Case esperado
- **`InlineT`**
  - Problema: skos:prefLabel 'Inline tee'@en não corresponde ao padrão esperado. Causa: palavra 'tee' deve começar com maiúscula (não é stopword)
- **`InlineT`**
  - Problema: skos:prefLabel ''T' em linha'@pt-br não corresponde ao padrão esperado. Causa: palavra 'linha' deve começar com maiúscula (não é stopword)
- **`RiserSupportBuoy`**
  - Problema: skos:prefLabel 'Bóia de sustentação de risers'@pt-br não corresponde ao padrão esperado. Causa: palavra 'sustentação' deve começar com maiúscula (não é stopword)
- **`RiserSupportBuoy`**
  - Problema: skos:prefLabel 'Riser support buoy'@en não corresponde ao padrão esperado. Causa: palavra 'support' deve começar com maiúscula (não é stopword)
- **`PumpingModule`**
...
- **Operação:** Geração de Arquivo de Revisão- **Arquivo Gerado:** `canonical_output_run4.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-02-27T01:25:49.492835

---
*Relatório gerado automaticamente em 2026-02-27 01:25:49*
