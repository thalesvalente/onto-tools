...
**Arquivo:** `audit-log-session-20260227-012547.json`
## 📊 Sumário Executivo
- **Operação:** Carregamento de Ontologia- **Arquivo:** `energy-domain-ontology.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-02-27T01:25:47.329442
...
- **Data/Hora:** 2026-02-27T01:25:47.931866
...
- **`WireRopeSlingDiameter`**
  - Problema: skos:definition precisa correção. Causa: [pt-br] falta ponto final
- **`TapesQuantity`**
  - Problema: skos:definition precisa correção. Causa: [en] whitespace extra
- **`FlowControlModule`**
...
- **`ConnectionModule`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'module'→'Module'; [pt-br] Title Case: 'conexão'→'Conexão'
- **`Jumper`**
...
- **`TreeRunningTool`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'tree'→'Tree', 'running'→'Running', 'tool'→'Tool'; [pt-br] Title Case: 'instalação'→'Instalação', 'ANM'→'Anm'
- **`ModulusOfElasticity`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Of'→'of'; [pt-br] Title Case: 'elasticidade'→'Elasticidade'
- **`FrictionCoefficientTighteningTable_TighteningPerTrack`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Per'→'per'; [pt-br] Title Case: 'lagarta'→'Lagarta'
- **`HPHousing`**
...
- **`NumberOfRemoteProcessIsolationValves`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'Of'→'of'; [pt-br] Title Case: 'válvulas'→'Válvulas', 'isolamento'→'Isolamento', 'processo'→'Processo'
- **`LogicCap`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'cap'→'Cap'; [pt-br] Title Case: 'lógica'→'Lógica'
- **`ElectricalCable`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'cable'→'Cable'; [pt-br] Title Case: 'elétrico'→'Elétrico'
- **`SolubilityTable_SolubilityCoefficient`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'solubilidade'→'Solubilidade'
- **`RiserSupport`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'support'→'Support'; [pt-br] Title Case: 'riser'→'Riser'
- **`IsSpare`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'sobressalente'→'Sobressalente'
- **`StrIntOnNoTensMaxPressValRef`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'With'→'with'
- **`RunningTool`**
...
- **`DistributionModule`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'module'→'Module'; [pt-br] Title Case: 'distribuição'→'Distribuição'
- **`QuickDisconnectionTool`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'disconnection'→'Disconnection', 'tool'→'Tool'; [pt-br] Title Case: 'desconexão'→'Desconexão', 'rápida'→'Rápida'
- **`TubingHangerRunningTool`**
...
- **`ProjectCode`**
  - Problema: skos:prefLabel precisa correção. Causa: [pt-br] Title Case: 'único'→'Único', 'projeto'→'Projeto', 'operadora'→'Operadora'
- **`DeploymentAccessory`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'accessory'→'Accessory'; [pt-br] Title Case: 'lançamento'→'Lançamento'
- **`GroutBag`**
  - Problema: skos:prefLabel precisa correção. Causa: [en] Title Case: 'bag'→'Bag'; [pt-br] Title Case: 'bag'→'Bag'

- **Operação:** Geração de Arquivo de Revisão- **Arquivo Gerado:** `canonical_output_run3.ttl`- **Status:** ✅ success- **Data/Hora:** 2026-02-27T01:25:48.202272

---
*Relatório gerado automaticamente em 2026-02-27 01:25:48*
