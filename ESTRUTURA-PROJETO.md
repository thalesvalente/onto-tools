...
## Estrutura Atual (v3.0 — atualizado RC1)
...
│   │   │   └── YYYYMMDDTHHMMSSZ_<uuid8>/  # Bundle com ~60 artefatos
...
│       ├── RC_TEMPLATE_DESIGN-rcNN-v3.md  # Estrutura canônica (v3.0)
│       └── RC_EXECUTION_PROMPT-rcNN-v3.md # Prompt de execução (v3.0)
│
...
| Script | Propósito |
|--------|-----------|
| `scripts/run_rc.py` | Pipeline RC completo (Fases 1-6) |
| `scripts/fill_rc_bundle.py` | Preenchimento do bundle RC (Fases 7-8) |
...
- **RC Templates**: `docs/rc-templates/RC_TEMPLATE_DESIGN-rcNN-v3.md`
