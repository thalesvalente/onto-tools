...
**Bundle de evidência**
Diretório gerado ao final de uma execução RC (Reproducibility Certification), contendo: manifesto, artefatos canônicos, relatórios de isomorfismo e idempotência, logs de auditoria. Estrutura definida em `docs/rc-templates/RC_TEMPLATE_DESIGN-rc13.md`.
...
│  scripts/menu.ps1      scripts/run_rc13.py (RC pipeline)     │
└────────────────────────┬─────────────────────────────────────┘
                         │
┌────────────────────────▼─────────────────────────────────────┐
│                   APPLICATION LAYER                          │
...
scripts/
├── run_rc13.py              # Pipeline RC (Fases 1-6)
...
└── rc-templates/            # Templates para RCs futuros
    ├── RC_TEMPLATE_DESIGN-rc13.md
    └── RC_EXECUTION_PROMPT-rc13.md
...
com ~60 artefatos verificáveis. Último: **RC_v13_CANON** (963 testes, 95.04% coverage).
...
Templates e prompt de execução: `docs/rc-templates/RC_TEMPLATE_DESIGN-rc13.md`
